...
import ICacheProvider from '@shared/container/providers/CacheProvider/models/ICcacheProvider';
...
class CreateAppointmentService {
  ...
  public async execute({
    ...
    if (user_id === provider_id) {
      throw new AppError("You can't register an appointment with yourself");
    }
